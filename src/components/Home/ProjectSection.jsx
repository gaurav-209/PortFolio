...
const ProjectSection = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Projects | Gaurav Mahavar</title>
        <meta name="description" content="Explore React.js projects by Gaurav Mahavar." />
      </Helmet>
      <section id='projects' className='py-20'>
        <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='mb-8 flex flex-wrap justify-center gap-3' data-aos="zoom-in">
            <button
    ...
    >
      <div className='h-48 overflow-hidden'>
        <img
          ...
          alt={`${project.title} by Gaurav Mahavar`}
      ...
      <div className='p-6'>
        ...
        <div className='flex space-x-3'>
          ...
          <a href={`/CaseStudy/${project.title}`}>Case Study </a>
        </div>
      </div>
    </article>
  )
